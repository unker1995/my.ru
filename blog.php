			...
			<div class="row">
				...
				<?php
					...
					foreach ($data as $value) {
						...
						echo '<div class="post_date montserrat-text uppercase">'.$value[2].'</div>';
						echo '</div>';
						echo '<p>'.$value[3].'</p>';
						echo '<a href="/blog/article.php?id='.$value[0].'" class="link montserrat-text uppercase">continue reading <i class="icon ion-arrow-right-c"></i></a>';
						echo '</div>';
					}
				?>
